...
class TestProcessors:
    ...
    def test_reproject(self):
        ...
        assert len(self.gdf) == reprojected.summary.row_modifications["modified"], (
    ...
    def test_reproject_no_changes(self):
        ...
        assert not reprojected.summary.row_modifications, (
    ...
    def test_strip_columns(self):
        ...
        assert {"b": len(self.whitespace_df)} == stripped.summary.row_modifications[
            "modified"
        ]
    ...
    def test_strip_all_columns(self):
        ...
        } == stripped.summary.row_modifications["modified"], (
    ...
    def test_coerce_column_type(self, original_column, cast, errors, expected_column):
        ...
        # TODO
        assert coerced.summary.column_modifications["modified"] == {
            original_column: str(self.coerce_df[expected_column].dtype)
        }
